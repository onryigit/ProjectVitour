    ...
    public static class SeedData
    {
        public static void Initialize(IDatabaseSettings settings)
        {
            ...
            var tourDefinitions = new[]
            {
                ...
                new { Title = "Paris Gurme Gezisi ve Şarap Tadımı", Desc = "Fransız mutfağının inceliklerini Michelin yıldızlı şeflerin atölyelerinde öğreneceğiniz lezzet dolu bir program.", Cover = "1517248135467-4c7edcad34c4", Badge = "Yeni", Dest = d1, Day = 3, Price = 950 },
                ...
                new { Title = "Paris Müzeleri: Rönesans'a Yolculuk", Desc = "Orsay ve Louvre müzelerine VIP bilet ile giriş imkanı sunan, tamamen sanat tarihine adanmış bir hafta sonu.", Cover = "1518998053901-5375273c15b5", Badge = "Kültür Turu", Dest = d1, Day = 3, Price = 1100 },

                // ROMA
                new { Title = "Antik Roma ve Gladyatörlerin İzi", Desc = "Kolezyum'un yeraltı tünellerinden başlayarak Antik Roma Forumu'nda tarihin tozlu sayfalarını aralayacaksınız.", Cover = "1552832230-c0197dd311b5", Badge = "Çok Tercih Edilen", Dest = d2, Day = 4, Price = 1050 },
                new { Title = "Vatikan Sırları ve Sistina Şapeli", Desc = "Dünyanın en küçük ülkesi Vatikan'da Michelangelo'nun paha biçilemez eserlerini rehberimiz eşliğinde okuyun.", Cover = "1548625361-2e1d7f57077e", Badge = "Sınırlı Kontenjan", Dest = d2, Day = 3, Price = 980 },
                new { Title = "İtalyan Lezzetleri: Roma Sokak Yemekleri", Desc = "Trastevere mahallesinde odun ateşinde pizza ve geleneksel gelato tadımlarıyla dolu bir gastronomi serüveni.", Cover = "1551183053-bf91a1d81141", Badge = "Gurme", Dest = d2, Day = 3, Price = 850 },
                new { Title = "Aşıklar Çeşmesi ve Roma Geceleri", Desc = "Trevi Çeşmesi'nde dilek tutup, İspanyol Merdivenleri'nde sokak müzisyenlerini dinleyeceğiniz romantik rota.", Cover = "1533676802871-eca1eb96c8d6", Badge = "Popüler", Dest = d2, Day = 4, Price = 1150 },
                ...
                new { Title = "Nusa Penida Adaları Tekne Turu", Desc = "Manta vatozlarıyla şnorkel yapabileceğiniz, kristal berraklığındaki koylarda geçecek inanılmaz bir deniz turu.", Cover = "1537996194471-e657df975ab4", Badge = "Yeni", Dest = d3, Day = 3, Price = 950 },
                ...
                new { Title = "Kapadokya Mağara Otel Deneyimi", Desc = "Tamamen kayalara oyulmuş, modern lüksle birleşen otantik mağara otellerde eşsiz bir konaklama ayrıcalığı.", Cover = "1604084797086-63d1cc96c429", Badge = "Premium", Dest = d4, Day = 4, Price = 850 },
                new { Title = "Kızılvadi Atlı Safari Turu", Desc = "Gün batımında volkanik kayaların kızıla boyandığı anları at sırtında, profesyoneller eşliğinde yaşayın.", Cover = "1527631746610-bca00a040d60", Badge = "Macera", Dest = d4, Day = 2, Price = 350 },
                ...
                new { Title = "Kyoto Geleneksel Lezzet Rotaları", Desc = "Sushi, Ramen ve Matcha çayının anavatanında sokak pazarlarını uzman rehberle gezeceğiniz lezzet haritası.", Cover = "1493976040374-85c8e12f0c0e", Badge = "Yeni", Dest = d5, Day = 4, Price = 1450 },

                // MALDIVLER
                new { Title = "Maldivler Su Üstü Villa Konaklaması", Desc = "Gözünüzü turkuaz sulara açacağınız, cam tabanlı lüks su üstü villalarında kişiye özel hizmet veren rüya tatil.", Cover = "1514282401089-ce3a571e2372", Badge = "Premium", Dest = d6, Day = 7, Price = 4500 },
                new { Title = "Maldivler Tüplü Dalış ve Resifler", Desc = "Dünyanın en zengin mercan resiflerinde, renkli tropikal balıklar ve deniz kaplumbağalarıyla birlikte yüzeceksiniz.", Cover = "1544551763836-1e967406c117", Badge = "Macera", Dest = d6, Day = 5, Price = 3200 },
                new { Title = "Maldivler Özel Tekne ile Ada Avı", Desc = "Sadece size tahsis edilmiş tekneyle ıssız adalara yolculuk, kumsalda size özel hazırlanan barbekü partisi.", Cover = "1499793983690-e29da59ef1c2", Badge = "Lüks", Dest = d6, Day = 6, Price = 3800 },
                new { Title = "Maldivler Deniz Uçağı Transferli Tatil", Desc = "Başkentten adanıza deniz uçağıyla geçerken Hint Okyanusu'nun muhteşem atol manzaralarına şahit olun.", Cover = "1506695238775-bf28292850cd", Badge = "Fırsat", Dest = d6, Day = 5, Price = 2900 },
                new { Title = "Maldivler Aile Boyu Huzur Paketi", Desc = "Çocuk kulüpleri ve geniş sahil villaları ile ailenizle stresten uzak, bembeyaz kumlarda bir dinlenme fırsatı.", Cover = "1507525428034-b723cf961d3e", Badge = "Aile", Dest = d6, Day = 7, Price = 4100 }
            };
